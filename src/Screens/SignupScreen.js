                            ...
                            : stepIndex === 4 ?
                                ...
                                : stepIndex === 5 ?
                                    <View style={{ flex: 1, alignItems: 'center' }}>
                                        ...
                                        <Text style={{marginLeft: 10, marginRight: 10, marginTop: 15}}>
                                            Bằng cách nhấn vào Đăng ký, bạn đồng ý với Điều khoản, Chính sách dữ liệu và Chính sách cookie của chúng tôi.
                                            Bạn có thể nhận dc thông báo của chúng tôi qua SMS và chọn không nhận bất cứ lúc nào. Thông tin từ danh bạ
                                            của bạn sẽ được tải lên Facebook liên tục để chúng tôi có thể gợi ý bạn bè, cung cấp và cải thiện quảng cho bạn và người
                                        ...
                                        <View style={{ justifyContent: 'center', alignItems: 'center', marginHorizontal: 30 }}>
                                            <Button title="Đăng ký"
                                                uppercase={false}
                                                color={COMMON_COLOR.BLUE_COLOR}
                                                style={{ width: '100%', position: 'absolute', top: height / 3, zIndex: 9999 }}
